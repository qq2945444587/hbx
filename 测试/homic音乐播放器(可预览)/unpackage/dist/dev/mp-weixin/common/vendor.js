...
function populateParameters(result) {
  ...
  var parameters = {
    appId: "__UNI__18E410A",
    appName: "homic音乐播放器(可预览)",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"homic音乐播放器(可预览)","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!*******************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/pages.json ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!***********************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/store/index.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _cache = __webpack_require__(/*! @/utils/cache.js */ 38);
var _user = __webpack_require__(/*! @/api/modules/user.js */ 39);
var _search = __webpack_require__(/*! @/api/modules/search.js */ 41);
var _index = __webpack_require__(/*! @/plugins/audio/index.js */ 42);
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    SET_PLAY_INFO: function SET_PLAY_INFO(state, playInfo) {
      state.playInfo = playInfo;
      (0, _cache.setCache)("PLAY_INFO", playInfo);
    },
    SET_PASUED: function SET_PASUED(state, paused) {
      state.paused = paused;
    }
  },
  actions: {
    ...
    addHistoryList: function addHistoryList(_ref2, val) {
    ...
    changePlay: function changePlay(_ref4, count) {
      var state = _ref4.state,
        commit = _ref4.commit,
        dispatch = _ref4.dispatch;
      if (_index.audio.audiolist.length == 1) {
        _index.audio.operate(0);
        commit("SET_PASUED", false);
        return;
      }
      _index.audio.changeplay(count);
      var playIndex = _index.audio.audiolist.findIndex(function (item) {
        return item.id == state.playInfo.id;
      });
      var tempIndex = -1;
      if (count === 1) {
        //下一首
        if (playIndex == _index.audio.audiolist.length - 1) {
          tempIndex = 0;
        } else {
        ...
        if (playIndex == 0) {
          tempIndex = _index.audio.audiolist.length - 1;
        } else {
          tempIndex = playIndex - 1;
        }
      }
      dispatch("playMusic", _index.audio.audiolist[tempIndex]);
    },
    //从对应歌曲列表中删除 当前歌曲
    removeMusic: function removeMusic(_ref5, val) {
      var state = _ref5.state,
        commit = _ref5.commit;
      var audioList = (0, _toConsumableArray2.default)(_index.audio.audiolist);
      var index = audioList.findIndex(function (item) {
        return item.id == val.id;
      });
      audioList.splice(index, 1);
      _index.audio.setAudio(audioList);
      (0, _cache.setCache)("PLAY_LIST", audioList);
    ...
    //播放全部
    playAllMUsic: function playAllMUsic(_ref6, list) {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        var state, commit, data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return getMusic(list[0].id);
              case 3:
                data = _context.sent;
                list[0].src = data.url;
                _index.audio.setAudio(list);
    ...
    //点击播放
    playMusic: function playMusic(_ref7, val) {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
        var state, commit, audioList, index, data, playIndex, _data;
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                state = _ref7.state, commit = _ref7.commit;
                audioList = (0, _toConsumableArray2.default)(_index.audio.audiolist);
                index = audioList.findIndex(function (item) {
                  return item.id === val.id;
                }); //如果当前播放列表不存在当前音乐
                if (!(index === -1)) {
                  _context2.next = 18;
                ...
                _context2.next = 6;
                return getMusic(val.id);
              case 6:
                data = _context2.sent;
                val.src = data.url;
                playIndex = 0;
                if (state.playInfo) {
                  playIndex = audioList.findIndex(function (item) {
                    return item.id == state.playInfo.id;
                  });
                }
                ...
                _index.audio.setAudio(audioList);
                (0, _cache.setCache)("PLAY_LIST", audioList);
                _index.audio.operate(playIndex === -1 ? 0 : playIndex + 1);
              ...
              case 21:
                ...
                break;
              case 28:
                val.src = "https://music.163.com/song/media/outer/url?id=".concat(val.id, ".mp3");
              case 29:
                _index.audio.operate(index);
...
/* 38 */
/*!***********************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/utils/cache.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.setCache = exports.removeCache = exports.getCache = void 0;
...
/* 39 */
/*!****************************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/api/modules/user.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.login = exports.likeMusic = exports.likeData = exports.getUserInfo = exports.getUserHistory = exports.getLoginStatus = void 0;
...
/* 40 */
/*!*************************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/utils/request.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 41 */
/*!******************************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/api/modules/search.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getSuggestList = exports.getSearchList = exports.getMusicUrl = exports.getLyric = exports.getHotDetailSearch = exports.getDefaultSearch = exports.checkMusicUrl = void 0;
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 40));
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
/* 42 */
/*!*******************************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/plugins/audio/index.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ 4);
var _zaudio = _interopRequireDefault(__webpack_require__(/*! ./zaudio.js */ 43));
var _cache = __webpack_require__(/*! @/utils/cache.js */ 38);
var audio = new _zaudio.default({
  continuePlay: false,
  //续播
  autoPlay: false //自动播放 部分浏览器不支持
});

audio.setAudio((0, _cache.getCache)('PLAY_LIST'));
module.exports = {
  audio: audio
};
...
/* 43 */
/*!********************************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/plugins/audio/zaudio.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _regeneratorRuntime = __webpack_require__(/*! @babel/runtime/regenerator */ 34);
...
var _get = __webpack_require__(/*! @babel/runtime/helpers/get */ 44);
var _inherits = __webpack_require__(/*! @babel/runtime/helpers/inherits */ 47);
var _possibleConstructorReturn = __webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ 48);
var _getPrototypeOf = __webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ 46);
...
var util_1 = __webpack_require__(/*! ./util */ 50);
/**
 * ZAudio类
 * @class ZAudio
 * @constructor
...
var superPropBase = __webpack_require__(/*! ./superPropBase.js */ 45);
function _get() {
...
/* 50 */
/*!******************************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/plugins/audio/util.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 51 */
/*!*********************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/api/index.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var home = __webpack_require__(/*! ./modules/home */ 52);
var user = __webpack_require__(/*! ./modules/user */ 39);
var search = __webpack_require__(/*! ./modules/search */ 41);
var song = __webpack_require__(/*! ./modules/song */ 53);
var rankList = __webpack_require__(/*! ./modules/rankList */ 54);
var singer = __webpack_require__(/*! ./modules/singer */ 55);
var _default = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, home), user), search), song), rankList), singer);
exports.default = _default;

/***/ }),
/* 52 */
/*!****************************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/api/modules/home.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getSelectionData = exports.getRecommendList = exports.getNewSongList = exports.getHotSingerList = exports.getDayRecommendMusicList = exports.getDayRecommendList = exports.getBanner = void 0;
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 40));
var _cache = __webpack_require__(/*! @/utils/cache.js */ 38);
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
var getRecommendList = function getRecommendList(params) {
  return _request.default.post('/personalized', _objectSpread(_objectSpread({}, params), {}, {
    cookie: (0, _cache.getCache)('COOKIE')
  }));
};
...
/* 53 */
/*!****************************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/api/modules/song.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getSongTagList = exports.getSongList = exports.getPlayListData = exports.getPlayDetail = void 0;
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 40));
/**
 *  歌单 获取歌单分类标签
 *  @return {Array}
...
/* 54 */
/*!********************************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/api/modules/rankList.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 55 */
/*!******************************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/api/modules/singer.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getSingerList = exports.getSingerInfo = exports.getSingerAllMusic = void 0;
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 40));
/**
 *  获取所有 热门歌手
 *  @return {Array}
...
var getSingerInfo = function getSingerInfo(params) {
  return _request.default.get('/artist/detail', params);
};
...
/* 62 */
/*!***********************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/utils/index.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.filterPlayCount = filterPlayCount;
...
function filterPlayCount(val) {
  if (!val || val <= 0) return 0;else if (val < 1000) return val;else if (val >= 1000 && val < 10000) return Math.ceil(val / 1000) + '千';else if (val >= 10000 && val < 100000000) return Math.ceil(val / 10000) + '万';
...
/* 119 */
/*!**********************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/utils/date.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getYear = exports.getMonth = exports.getDay = void 0;
var getYear = function getYear() {
  var date = new Date();
  return date.getFullYear();
};
exports.getYear = getYear;
var getMonth = function getMonth(key) {
  var date = new Date();
  return addZero(date.getMonth() + 1);
};
exports.getMonth = getMonth;
var getDay = function getDay(key) {
  var date = new Date();
  return addZero(date.getDate());
};
exports.getDay = getDay;
var addZero = function addZero(date) {
  return date > 9 ? date : "0".concat(date);
};
...
/* 136 */
/*!********************************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/plugins/pinyin/utils.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getGroupByPinyin = getGroupByPinyin;
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _toConsumableArray2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ 18));
var _toPinyin = _interopRequireDefault(__webpack_require__(/*! ./toPinyin */ 137));
 ...
 */
function getGroupByPinyin(arr) {
  var key = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'name';
  if (!arr) return;

  // 获取A-Z字母数组
  var keys = (0, _toConsumableArray2.default)(Array(26).keys()).map(function (i) {
    return String.fromCharCode(i + 65);
  });
  arr = arr.map(function (n) {
    return _objectSpread(_objectSpread({}, n), {}, {
      py: _toPinyin.default.chineseToInitials(_toPinyin.default.chineseToPinYin(n[key].substr(0, 1)))
    });
  });
  var group = [];
...
/* 137 */
/*!***********************************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/plugins/pinyin/toPinyin.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ 24));
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _pinyin = _interopRequireDefault(__webpack_require__(/*! ./pinyin */ 138));
/*
 * @Autor: lieft@qq.com
 ...
 * @description: 转拼音 
 */
var ToPinyin = /*#__PURE__*/function () {
  function ToPinyin() {
    (0, _classCallCheck2.default)(this, ToPinyin);
  }
  (0, _createClass2.default)(ToPinyin, [{
    key: "chineseToInitials",
    value:
    ...
    key: "chineseToPinYin",
    value: function chineseToPinYin(l1) {
      var l2 = l1.length;
      var I1 = '';
    ...
    key: "arraySearch",
    value: function arraySearch(l1, l2) {
...
(0, _defineProperty2.default)(ToPinyin, "instance", void 0);
var toPinyin = ToPinyin.getInstance();
var _default = toPinyin;
exports.default = _default;

/***/ }),
/* 138 */
/*!*********************************************************!*\
  !*** F:/我的/测试/homic音乐播放器(可预览)/plugins/pinyin/pinyin.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
