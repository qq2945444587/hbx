<template>
	<view class="container">
		...
		<view class="s-list-box" :style="{ paddingTop: top + 'px' }">
			<s-list-view :title="'总收藏（'+total+'）位作者'">
					...
					<view class="s-list-item">
						...
						<view class="s-item-info">
							<view class="s-item-name">
								<rich-text :nodes="item.author_one.name"></rich-text>
							</view>
							<view class="s-item-author">
								[{{item.author_one.dynasty}}]
							</view>
						</view>
					</view>
				</s-list-cell>	
...
<script>
	...
	import { getAuthorList } from '../../services/collection/api.js';
...
@import 'collectionAuthorList.scss';
</style>
